...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="radio" name="status" value="1" <?php if(($info["status"]) == "1"): ?>checked="checked"<?php endif; ?>>未读
                <input type="radio" name="status" value="2" <?php if(($info["status"]) == "2"): ?>checked="checked"<?php endif; ?>>已读
            </div>
        </div>
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav("<?php echo U('sponsorApply');?>");
        $(function(){
