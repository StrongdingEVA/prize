...
<body>
    ...
    <div class="cf">
        <a class="btn" href="<?php echo U('recommendEdit');?>">新 增</a>
        <button class="btn ajax-post confirm" url="<?php echo U('recommendDel');?>" target-form="ids">删 除</button>
        ...
        <div class="search-form fr cf">
            ...
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('recommend');?>"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="data-table table-striped">
        <table>
            ...
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <img src="<?php echo ($vo["icon"]); ?>" alt="未设置图标" width="80px;">
                        </td>
                        <td>
                            <?php echo ($vo["descript"]); ?>
                        </td>
                        ...
                        <td>
                            <a title="编辑" href="<?php echo U('recommendEdit',array('id'=>$vo['id']));?>">编辑</a>
                            <?php if($vo['status'] == 1): ?><a class="confirm ajax-get" title="设为禁用" href="<?php echo U('changeRecommend',array('id'=>$vo['id'],value=>2));?>">设为禁用</a>
                                <?php else: ?>
                                <a class="confirm ajax-get" title="设为启用" href="<?php echo U('changeRecommend',array('id'=>$vo['id'],value=>1));?>">设为启用</a><?php endif; ?>
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('recommendDel',array('id'=>$vo['id']));?>">删除</a>
                        </td>
