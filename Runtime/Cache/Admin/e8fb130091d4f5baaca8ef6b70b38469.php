        ...
        <div class="search-form fr cf">
            <div class="sleft">
                <select name="type" id="type">
                    ...
                    <option value="1" <?php if(($type) == "1"): ?>selected<?php endif; ?>>支付订单</option>
                    <option value="2" <?php if(($type) == "2"): ?>selected<?php endif; ?>>退款订单</option>
                    <option value="3" <?php if(($type) == "3"): ?>selected<?php endif; ?>>提现订单</option>
                </select>
            </div>
            <div class="sleft">
                <input type="text" name="order_no" class="search-input" value="<?php echo I('order_no');?>" placeholder="请输入订单号">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('orderList');?>"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="data-table table-striped">
        <table>
            ...
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <?php if($vo['type'] == 1): ?>支付订单
                                <?php else: ?>
                                退款订单<?php endif; ?>
                        </td>
                        <td><?php echo (time_format($vo["create_time"])); ?></td>
                        <td>
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('orderDel',array('id'=>$vo['id']));?>">删除</a>
                        </td>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#type').change(function(){
                ...
                window.location.href = '<?php echo U("orderList");?>' + '&type=' + thisVal
            })
