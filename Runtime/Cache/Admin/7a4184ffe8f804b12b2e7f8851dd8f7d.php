...
<body>
    ...
    <div class="data-table table-striped">
        <table>
            ...
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><a href="/news/<?php echo ($vo["id"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a></td>
                        <td><?php echo ($vo["listorder"]); ?></td>
                        <td><?php echo ($vo["create_time"]); ?></td>
                        <td>
                            <a title="编辑" href="<?php echo U('edit',array('id'=>$vo['id']));?>">编辑</a>
                            <a href="<?php echo U('changeField',array('id'=>$vo['id'],'value'=>abs($vo['status']-1)));?>" class="ajax-get"><?php if(($vo["status"]) == "1"): ?>禁用<?php else: ?>启用<?php endif; ?></a>
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('del',array('id'=>$vo['id']));?>">删除</a>
                        </td>
    ...
    <script type="text/javascript">
        var URL = '/index.php?s=/Admin/Article';
