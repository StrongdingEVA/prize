...
<body>
    ...
    <div class="main-title">
        <h2><?php echo ($info['id']?'编辑':'新增'); ?>小程序</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <input type="hidden" name="icon" id="pics" value="<?php echo ($info["icon"]); ?>">
            <img class="modelspic" src="<?php echo ($info["icon"]); ?>" alt="">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <div class="controls">
                    <textarea name="descript" cols="60" rows="5"><?php echo ($info["descript"]); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                ...
                <input type="radio" name="status" value="2" <?php if(($info["status"]) == "2"): ?>checked="checked"<?php endif; ?>>禁用
            </div>
        </div>
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav("<?php echo U('recommend');?>");
        $(function(){
